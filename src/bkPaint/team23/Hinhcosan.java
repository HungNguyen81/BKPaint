...
public class Hinhcosan {
    ...
    public JComboBox createCB() {
        String[] Hinhcosan = {"con thỏ", "con mèo", "con chó", "con gấu", "con ong", "con bướm",
                "máy bay", "xe buýt", "ốc sên", "bánh sinh nhật", "bông hoa", "quả táo", "tàu ngầm",
                "tàu thủy", "tàu hỏa"};
        JComboBox drowDown = new JComboBox(Hinhcosan);
//        controlPanel.add(drowDown);
        String Dir1 = System.getProperty("user.dir") + "\\src\\hinhcosan\\";
        String[] listImageSrc = {"Temp", "tho.png", "meo.png", "cho.png", "gau.png",
